# Hasil retest — ETM-15526 TC-13 / TC-14 / TC-15
...
|----|------------------|--------------------------|
| TC-13 | Origin ≠ Remapped To di insert / update Origin / update Qty / approve | **BLOCKED** — tidak ada baris Origin yang bisa diedit |
| TC-14 | Edit Remapped To / Qty / Description tidak memindahkan baris | **BLOCKED** — tidak ada 2 baris Origin Mix + Pink |
| TC-15 | Qty non-numerik ditolak; semua error required tampil; failed row = jumlah baris gagal | **BLOCKED / tidak sampai skenario** — upload import 404 |
...
Contoh RM Open existing: [RM-5U3DKHWT](https://staging.olshoperp.com/accounting/stock-remapping/edit/129865) — building Seruni DROP OFF, tabel detail **no data available in table**.
...
`POST /api/accounting/stock-remapping-detail/130412/import-history/upload` → **404**  
...
`implementation-card/[ETM-15526]/retest-failed-tc/` — `tc15-result.json`, screenshot import, screenshot RM-5U3DKHWT kosong.
