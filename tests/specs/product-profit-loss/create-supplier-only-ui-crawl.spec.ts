...
test('[@TC-GC-CRAWL-SUPPLIER-ONLY-20260823082955] Create New General Company ONLY Recognized As Supplier via Web UI Crawling (Company 153 - Lumi Charms.id)', async ({ page }) => {
