...
flowchart LR
    ...
    subgraph Fulfillment
        F[Wave Assignment]
        G[Picking → Checking → Packing → Collecting]
        H[Delivery Order]
        I[Inventory Out]
    end
    subgraph Finance
...
flowchart TB
    ...
    SETTLE -->|generate outbound + invoice| OUT & INV
    INV --> PAY --> JRNL
    OUT --> JRNL
    SOG --> RET & RETACC
...
| 6 | **Other Cost / Discount** | Omni | **Opsional** | Biaya/diskon tambahan | Mengubah grand total; masuk invoice & settlement |
...
| 16 | **Failed Ship** | SCM | **Error handling** | SO gagal kirim | Retry / unlink dari DO |
