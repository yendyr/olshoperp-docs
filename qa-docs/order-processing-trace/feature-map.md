...
**Routes:** `/supplychain/order-processing-trace` · `/omni/order-processing-trace` (halaman sama) · **Jira:** [ETM-15713](https://erpintegration.atlassian.net/browse/ETM-15713)
...
| SF-OPT-01 | [Dual entry SCM & Omni](#sf-lingo:SF-OPT-01) | menu | TO-BE | detailed | capabilities · sf-opt-01 | Ya | pending |
