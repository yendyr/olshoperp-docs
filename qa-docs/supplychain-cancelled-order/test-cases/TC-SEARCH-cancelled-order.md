...
tc_code: TC-SEARCH-cancelled-order
...
related_menus: []
preconditions:
  - "Hasil serial dari TC-VIEW-cancelled-order (sample SO code) atau token 'void'."
test_data:
  - field: "Search"
...
# TC-SEARCH-cancelled-order

## Catatan automation

- Spec: `@TC-SEARCH-cancelled-order`
