...
tc_code: TC-UPDATE-warehouse-level
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-UPDATE-warehouse-level — chain setelah TC-CREATE-warehouse-level"
---

# TC-UPDATE-warehouse-level

## Catatan automation

- Spec: `tests/specs/warehouse-type/warehouse-type-create-update.spec.ts` (tag `@TC-UPDATE-warehouse-level`)
