...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-CREATE-tagging — 2/2 serial PASS (~1.0m)"
---
...
- Spec: `tests/specs/tagging/tagging-create-update.spec.ts` (tag `@TC-CREATE-tagging`)
- Helper: `tests/helpers/tagging.ts`
- Registry: `tests/pom-registry/tagging.yaml`
- Chain: hasil create dipakai `@TC-UPDATE-tagging`.
