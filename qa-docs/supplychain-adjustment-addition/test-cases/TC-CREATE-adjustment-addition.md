...
tc_code: TC-CREATE-adjustment-addition
...
run_history:
  - at: "2026-07-15"
    status: passed
    note: "Playwright @TC-CREATE-adjustment-addition — serial 3/3 PASS (~3.5m)"
---

# TC-CREATE-adjustment-addition
...
- Spec tag: `@TC-CREATE-adjustment-addition`
