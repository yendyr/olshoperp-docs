...
tc_code: TC-UPDATE-adjustment-addition-detail
...
run_history:
  - at: "2026-07-15"
    status: passed
    note: "Playwright @TC-UPDATE-adjustment-addition-detail — serial 3/3 PASS"
---

# TC-UPDATE-adjustment-addition-detail
...
- Spec tag: `@TC-UPDATE-adjustment-addition-detail`
