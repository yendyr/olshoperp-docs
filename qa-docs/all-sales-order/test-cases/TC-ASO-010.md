...
automated: true
automated_spec: tests/specs/sales-order/aso-cogs-error-flag-tc7.spec.ts
execution_company:
  id: 153
  code: lumicharmsid
related_menus:
...
test_result:
  ...
  environment: staging
  log_summary: "Automated Playwright E2E test PASSED: Kolom Error Flag ter-render pada list Failed Process dan menampilkan icon dollar (cogs-error) pada transaksi under benchmark COGS."
  report_url: null
test_data_used: []
run_history: []
