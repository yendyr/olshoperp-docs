...
tc_code: TC-UPDATE-mutation-transfer-external
...
related_menus: []
preconditions:
  - "Dokumen dari TC-CREATE-mutation-transfer-external (serial); masih can_update; origin punya stock."
test_data:
...
# TC-UPDATE-mutation-transfer-external

## Catatan automation

- Spec: `@TC-UPDATE-mutation-transfer-external` (satu TC — description + Select Product).
