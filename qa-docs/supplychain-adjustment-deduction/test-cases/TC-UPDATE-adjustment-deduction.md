...
tc_code: TC-UPDATE-adjustment-deduction
...
related_menus: []
preconditions:
  - "Dokumen dari TC-CREATE-adjustment-deduction (serial)."
test_data:
...
run_history:
  - at: "2026-07-15"
    status: passed
    note: "Playwright @TC-UPDATE-adjustment-deduction"
---

# TC-UPDATE-adjustment-deduction

## Catatan automation

- Spec tag: `@TC-UPDATE-adjustment-deduction`
