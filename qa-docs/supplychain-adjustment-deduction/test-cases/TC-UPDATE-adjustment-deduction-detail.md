...
tc_code: TC-UPDATE-adjustment-deduction-detail
...
run_history:
  - at: "2026-07-15"
    status: passed
    note: "Playwright @TC-UPDATE-adjustment-deduction-detail — serial 3/3 PASS"
---

# TC-UPDATE-adjustment-deduction-detail

## Catatan automation

- Spec tag: `@TC-UPDATE-adjustment-deduction-detail`
