...
tc_code: PENDING-20260818083501
menu: system-product
...
expected_result: |
  ...
  [CATATAN QA] Jika child ternyata punya relasi tersembunyi, skenario pindah ke TC leftover (PENDING-20260818083500), bukan FAIL cabang zero-relation.
test_result:
  status: not_run
  started_at: null
  finished_at: null
...
Jangan pakai fixture yang sama dengan TC leftover (PENDING-20260818083500).
