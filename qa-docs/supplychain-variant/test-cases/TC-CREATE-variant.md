...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-CREATE-variant — re-run lumicharmsid"
---
...
- Spec: `tests/specs/variant/variant-create-update.spec.ts` (tag `@TC-CREATE-variant`)
- Helper: `tests/helpers/variant.ts`
- Registry: `tests/pom-registry/variant.yaml`
- Company: **lumicharmsid (153)**.
- Chain: hasil create dipakai `@TC-UPDATE-variant`.
