...
tc_code: TC-CREATE-product-inventory-configuration
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-CREATE-product-inventory-configuration — 2/2 serial PASS (~1.3m)"
---

# TC-CREATE-product-inventory-configuration
