# Dev - Profit & Loss — Dokumentasi QA

Menu **Dev - Profit & Loss** (Accounting / Report).
...
| Menu | Link |
|------|------|
| Profit & Loss (produksi) | [../accounting-profit-loss/](../accounting-profit-loss/) — multi-period + export |
| Chart of Account | [../accounting-chart-of-account/](../accounting-chart-of-account/) — struktur akun |
| Journal | [../journal/](../journal/) — sumber debit/credit Approved |
