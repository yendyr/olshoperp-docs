...
tc_code: TC-UPDATE-warehouse-structure
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-UPDATE-warehouse-structure — chain setelah create; workaround Drop Off update bug"
---

# TC-UPDATE-warehouse-structure

## Catatan automation

- Spec tag: `@TC-UPDATE-warehouse-structure`
