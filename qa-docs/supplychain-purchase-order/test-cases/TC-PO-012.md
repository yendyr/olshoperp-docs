...
steps:
  ...
  - "Klik tombol Create PO"
  - "Pilih Supplier"
  - "Pilih Destination Warehouse"
  - "Pilih Tipe PO"
  - "Simpan Header PO"
  - "Buka Accordion Purchase Order Detail"
  - "Tambahkan Product SKU ke Detail"
  - "Input Order Quantity & Unit Price"
  - "Periksa Konfigurasi & Kalkulasi VAT / PPN"
  - "Simpan Transaksi PO"
  - "Approve Transaksi Purchase Order"
expected_result: |
  Transaksi Purchase Order berhasil dibuat via Web UI Crawling di company Lumi Charms.id (ID: 153).
  Supplier yang digunakan sesuai dengan hasil test crawling TC-GC-CRAWL-SUPPLIER-ONLY-20260823082955 (SUPP-ONLY-1787448592996).
  Produk yang masuk ke line detail sesuai dengan hasil test crawling TC-SYSPROD-004 (LUMI-CRAWL-1787447920177).
