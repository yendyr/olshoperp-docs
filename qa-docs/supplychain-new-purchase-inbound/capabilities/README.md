...
Entry Lingo-style **khusus menu BETA**. Shared UI → [`_meta/shared-capabilities/`](../../_meta/shared-capabilities/).

Struktur body: **Apa ini** → **Kapan dipakai** → **Cara pakai** → **Catatan** → **Contoh** → **Lihat juga**.
