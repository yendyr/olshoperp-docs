...
tc_code: TC-UPDATE-stock-opname-detail
...
run_history:
  - at: "2026-07-15"
    status: passed
    note: "Playwright @TC-UPDATE-stock-opname-detail — add available product + qty on SP-6A56E465"
---

# TC-UPDATE-stock-opname-detail
...
- Spec tag: `@TC-UPDATE-stock-opname-detail`
