...
**Help Center overview:** [`_meta/docs-hub/menus/supplychain-assembly/`](../_meta/docs-hub/menus/supplychain-assembly/) (`overview.en.md` / `overview.id.md`)
...
| 2026-07-04 | Full doc rewrite v2.0 — merge PM requirement, codebase verification, stock movement chain |
| 2026-06-19 | Initial draft from codebase analysis |
