...
tc_code: TC-UPDATE-dimension-weight-label
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-UPDATE-dimension-weight-label — chain setelah create"
---

# TC-UPDATE-dimension-weight-label

## Catatan automation

- Spec tag: `@TC-UPDATE-dimension-weight-label`
