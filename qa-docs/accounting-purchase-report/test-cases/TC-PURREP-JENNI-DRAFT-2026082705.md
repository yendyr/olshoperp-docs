...
owner: QA - Jenni
tc_code: PENDING-JENNI-2026082705
title: "POV Purchase Invoice — Validasi Date Range Gate, Filter SearchBuilder & Export File"
status: draft
module: Accounting
...
# Test Case: POV Purchase Invoice — Validasi Date Range Gate, Filter SearchBuilder & Export File
...
- Advanced Filter & Global Search mampu memfilter data POV PI dengan akurat.
