...
title: "Fitur sorting kolom Receiving Status tidak berfungsi dan urutan print screen tidak sinkron"
summary: "Verifikasi fungsionalitas sorting kolom Receiving Status berjalan secara Ascending dan Descending di UI dan print screen."
status: draft
owner: QA - Jeiniffer
...
related_menus: []
preconditions:
  - "Dokumen Purchase Requisition PR-6A8BF9DB (status Complete) memiliki status keterikatan receiving (processed)."
...
steps:
  ...
  - "Klik header kolom Receiving Status untuk mengaktifkan sorting Ascending."
  - "Amati urutan baris di UI, lalu klik tombol Print."
  - "Klik kembali header kolom Receiving Status untuk beralih ke sorting Descending."
  - "Amati apakah urutan berubah atau tetap stuck."
expected_result: |
  - Sorting kolom Receiving Status di default screen UI berjalan dengan benar secara Ascending dan Descending.
...
run_history:
  - run_at: "2026-08-26T14:15:00+07:00"
    ...
    notes: "Sorting Receiving Status stuck di UI."
first_execution:
  at: null
  via: null
  jira: null
...
- **Hasil Observasi:** Kolom Receiving Status (kolom tambahan setelah approve) tidak merespons sorting di UI dan print out acak (pola sama dengan kolom PO Status).
