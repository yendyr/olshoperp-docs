# Stock History — Dokumentasi QA

Menu **Stock History** (Supply Chain / Report).
...
| Menu | Link |
|------|------|
| Product Mutation History | [../supplychain-product-mutation/](../supplychain-product-mutation/) — EB global + Calculate manual |
| Mutation Inbound / Outbound | Sumber Product In / Out |
| Transfer Internal / External | In/Out + Receiving Process |
| Adjustment Addition / Deduction | Koreksi stock |
