# Waves Management — Dokumentasi QA

Menu **Waves Management** (SupplyChain / OmniChannel).
...
**Version (3 layer):** 2.0 · **Last updated:** 2026-07-20
...
| Menu | Link |
|------|------|
| Unassign Wave | [../omni-unassign-wave/](../omni-unassign-wave/) — hulu masuk Default Waves |
| Skip Wave Process | [../omni-skip-wave-process/](../omni-skip-wave-process/) — batch alternatif ke Default Waves |
| Picking Process | [../omni-picking-process/](../omni-picking-process/) — hilir setelah PL |
| Picking List | [../omni-picking-list/](../omni-picking-list/) — dokumen picking |
