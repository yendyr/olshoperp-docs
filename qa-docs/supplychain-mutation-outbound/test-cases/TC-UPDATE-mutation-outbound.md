...
tc_code: TC-UPDATE-mutation-outbound
...
related_menus: []
preconditions:
  - "Dokumen dari TC-CREATE-mutation-outbound (serial); masih can_update; type Other; origin punya stock."
test_data:
...
# TC-UPDATE-mutation-outbound

## Catatan automation

- Spec: `@TC-UPDATE-mutation-outbound` (satu TC — description + Select Product).
