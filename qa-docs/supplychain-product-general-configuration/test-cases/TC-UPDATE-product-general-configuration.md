...
tc_code: TC-UPDATE-product-general-configuration
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-UPDATE-product-general-configuration — chain setelah create"
---

# TC-UPDATE-product-general-configuration

## Catatan automation

- Spec tag: `@TC-UPDATE-product-general-configuration`
