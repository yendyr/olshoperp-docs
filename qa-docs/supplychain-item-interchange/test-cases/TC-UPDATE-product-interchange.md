...
tc_code: TC-UPDATE-product-interchange
...
preconditions:
  ...
  - "Data dari TC-CREATE-product-interchange tersedia (serial automation)."
test_data:
...
run_history:
  - at: "2026-07-14"
    status: passed
    note: "Playwright @TC-UPDATE-product-interchange — chain setelah create"
---

# TC-UPDATE-product-interchange

## Catatan automation

- Spec tag: `@TC-UPDATE-product-interchange`
